...
public class MyRangeActivity extends BaseActivity implements
    ...
    TextView mTextPre,mTextNext,mTextNow;
    ...
    protected int getLayoutId() {
        return R.layout.activity_myrange;
    }
    ...
    protected void initView() {
        ...
        mTextPre = findViewById(R.id.tv_pre);
        mTextNow = findViewById(R.id.tv_now);
        mTextNext = findViewById(R.id.tv_next);
        ...
        mCalendarView.setRange(2024, 1, 1,
...
//                mCalendarView.setSelectCalendarRange(2024,3,29,2024,3,30);
                break;
            case R.id.iv_reduce:
    ...
    public void onMonthChange(int year, int month) {
        mTextNow.setText(year + "年" + month+"月");
